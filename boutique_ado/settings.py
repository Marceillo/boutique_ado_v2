...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://boutiqueadov2-da8587bc9277.herokuapp.com'
    ] 
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', # When media URL template tag not working
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutiqueadovmars'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'fi0jj0yr@students.codeinstitute.net'
else:
